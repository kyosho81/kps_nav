...
/* index 0x1017 :   Producer Heartbeat Time. */
                    ...
                    ODCallback_t win32test_Index1017_callbacks[] = 
                     {
                       NULL,
                     };
                    subindex win32test_Index1017[] = 
                     {
                       { RW, uint16, sizeof (UNS16), (void*)&win32test_obj1017 }
                     };
...
const indextable win32test_objdict[] = 
{
  ...
  { (subindex*)win32test_Index1017,sizeof(win32test_Index1017)/sizeof(win32test_Index1017[0]), 0x1017},
...
const indextable * win32test_scanIndexOD (UNS16 wIndex, UNS32 * errorCode, ODCallback_t **callbacks)
{
	...
	*callbacks = NULL;
	switch(wIndex){
		...
		case 0x1017: i = 3;*callbacks = win32test_Index1017_callbacks; break;
