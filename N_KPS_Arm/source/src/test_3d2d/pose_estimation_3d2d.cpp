...
int main ( int argc, char** argv )
{
    ...
    std::cout<<"all feature matches:"<<matches.size() <<endl;
    ...
    std::cout<<"3d-2d pairs: "<<pts_3d.size() <<endl;
    ...
    std::cout<<"calling bundle adjustment"<<endl;

	double ax = atan2(R.at<double>(2,1),R.at<double>(2,2));
	double ay = atan2( -R.at<double>(2,0) , sqrt( R.at<double>(2,1) * R.at<double>(2,1) + R.at<double>(2,2) * R.at<double>(2,2) ));
	double az = atan2(R.at<double>(1,0),R.at<double>(0,0));

	std::cout<<"x axle angle:"<<ax/3.1415*180<<std::endl;
	std::cout<<"y axle angle:"<<ay/3.1415*180<<std::endl;
	std::cout<<"a axle angle:"<<az/3.1415*180<<std::endl;
                            ...
                            std::vector< cv::DMatch >& matches )
{
    ...
    //when diff > 2 max diff err min diff use 30.
    for ( int i = 0; i < descriptors_1.rows; i++ )
    {
