...
pinger::pinger(boost::asio::io_service& io_service, const char* destination ,int i_ping_cnt  ) : 
...
void pinger::start_send()
{
	...
	// Send the request.
	time_sent_ = boost::posix_time::microsec_clock::universal_time();//boost 得到时间
