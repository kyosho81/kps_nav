#ifndef _DEVICE_WJ719_KYOSHO_20221027_
#define _DEVICE_WJ719_KYOSHO_20221027_
...
#include "sensor/wj719/vanjee_719_lidar_protocol.h"
//#include "sensor/wj719/wj719_driver.h"

class device_wj719 : protected device_laser
{
public:
...
private:
	...
	void pub_laser_ex(SLaser_Ex2 &laser_ex);
	void pub_ref(SReflector &laser_ref);
	void pub_laser_ex_ref(SLaser_Ex_Ref2 &laser_ex_ref);

	void pub_amcl_laser(float * range, float * intensity, int d_size);

	SReflector laser_ref_;
	SLaser_Ex_Ref2 laser_ex_ref2_;

	laser_filter_ex2 filter2_;
