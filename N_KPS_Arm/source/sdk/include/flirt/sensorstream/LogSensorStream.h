...
#include "flirt/sensorstream/LogReader.h"
#include "flirt/sensorstream/LogWriter.h"
#include "flirt/sensorstream/LogReader.h"
#include "flirt/sensors/AbstractReading.h"
...
class LogSensorStream: public SensorStream {
	...
	/** add by kyosho Load a log from proto file. */
	void load_maproto(const std::string& _filename);
	void load_maprotoex(const std::string& _filename);
	/** add by kyosho Load a log from frame file. */
	void load_frame(const std::string& _filename);
