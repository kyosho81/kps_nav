...
namespace pavo
{
	...
	public:
		...
		{	
			...
			ip_str = cComm::ConvertToString((int)ip_bytes[0]) + "." +
					 cComm::ConvertToString((int)ip_bytes[1]) + "." +
					 cComm::ConvertToString((int)ip_bytes[2]) + "." +
					 cComm::ConvertToString((int)ip_bytes[3]);
			return true;
		}
