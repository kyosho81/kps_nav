...
namespace GMapping {
  ...
  */
  ...
  private:
	...
	inline double optimize(OrientedPoint &opos,OrientedPoint &refpos,OrientedPoint &newpos,double* refScan,const double* curScan);
