...
class s_consumer : public ::google::protobuf::Message {
 public:
  s_consumer();
  virtual ~s_consumer();
  
  s_consumer(const s_consumer& from);
  
  inline s_consumer& operator=(const s_consumer& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const s_consumer& default_instance();
  
  void Swap(s_consumer* other);
  
  // implements Message ----------------------------------------------
  
  s_consumer* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const s_consumer& from);
  void MergeFrom(const s_consumer& from);
  void Clear();
  ...
  // @@protoc_insertion_point(class_scope:KPS.s_consumer)
 private:
  ...
  static s_consumer* default_instance_;
};
// ===================================================================
...
// required .KPS.mp_item_base base = 1;
inline bool s_consumer::has_base() const {
  return _has_bit(0);
}
inline void s_consumer::clear_base() {
  if (base_ != NULL) base_->::KPS::mp_item_base::Clear();
  _clear_bit(0);
}
inline const ::KPS::mp_item_base& s_consumer::base() const {
  return base_ != NULL ? *base_ : *default_instance_->base_;
}
inline ::KPS::mp_item_base* s_consumer::mutable_base() {
  _set_bit(0);
...
// repeated .KPS.mp_schedule schedule = 2;
inline int s_consumer::schedule_size() const {
  return schedule_.size();
}
inline void s_consumer::clear_schedule() {
  schedule_.Clear();
}
inline const ::KPS::mp_schedule& s_consumer::schedule(int index) const {
  return schedule_.Get(index);
}
inline ::KPS::mp_schedule* s_consumer::mutable_schedule(int index) {
  return schedule_.Mutable(index);
}
inline ::KPS::mp_schedule* s_consumer::add_schedule() {
  return schedule_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::KPS::mp_schedule >&
s_consumer::schedule() const {
  return schedule_;
}
inline ::google::protobuf::RepeatedPtrField< ::KPS::mp_schedule >*
s_consumer::mutable_schedule() {
  return &schedule_;
}

// required uint32 status = 3;
inline bool s_consumer::has_status() const {
  return _has_bit(2);
}
inline void s_consumer::clear_status() {
  status_ = 0u;
  _clear_bit(2);
}
inline ::google::protobuf::uint32 s_consumer::status() const {
  return status_;
}
inline void s_consumer::set_status(::google::protobuf::uint32 value) {
  _set_bit(2);
  status_ = value;
}

// optional string processer_uuid = 4;
inline bool s_consumer::has_processer_uuid() const {
  return _has_bit(3);
}
inline void s_consumer::clear_processer_uuid() {
  if (processer_uuid_ != &_default_processer_uuid_) {
    processer_uuid_->clear();
  }
  _clear_bit(3);
}
inline const ::std::string& s_consumer::processer_uuid() const {
  return *processer_uuid_;
}
inline void s_consumer::set_processer_uuid(const ::std::string& value) {
  _set_bit(3);
  if (processer_uuid_ == &_default_processer_uuid_) {
...
inline void s_consumer::set_processer_uuid(const char* value) {
  _set_bit(3);
  if (processer_uuid_ == &_default_processer_uuid_) {
    processer_uuid_ = new ::std::string;
  }
...
inline void s_consumer::set_processer_uuid(const char* value, size_t size) {
  _set_bit(3);
  if (processer_uuid_ == &_default_processer_uuid_) {
    processer_uuid_ = new ::std::string;
  }
...
inline ::std::string* s_consumer::mutable_processer_uuid() {
  _set_bit(3);
  if (processer_uuid_ == &_default_processer_uuid_) {
    processer_uuid_ = new ::std::string;
  }
